...
class HeapD
{
    ...
    static void Heapsort(double[] array, int n)
    {
        comparacoes = 0;
        movimentacoes = 0;
    ...
    static void Construir(double[] array, int ultimo)
    {
    ...
    static void Reconstruir(double[] array, int tamHeap)
    {
        int i = 0;
    ...
    static int GetMaiorFilho(double[] array, int i, int tamHeap)
    {
        int left = 2 * i + 1;
        int right = 2 * i + 2;
        comparacoes++;
